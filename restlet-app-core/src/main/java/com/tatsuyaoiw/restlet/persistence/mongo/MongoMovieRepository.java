...
public class MongoMovieRepository implements Repository<Movie> {
	...
	private static final MongoMovieRepository INSTANCE = new MongoMovieRepository();

	private MongoMovieRepository() {}

	public static MongoMovieRepository getInstance() {
		return INSTANCE;
	}
