...
public class MongoTrickRepository implements Repository<Trick> {
	...
	private static final MongoTrickRepository INSTANCE = new MongoTrickRepository();

	private MongoTrickRepository() {}

	public static MongoTrickRepository getInstance() {
		return INSTANCE;
	}
